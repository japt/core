...
class Common
{
   ...
   public function pager($itotal_rows , $ilimit,$aclass = array(), $spage_acr = "page" )
   {
       if($itotal_rows/$ilimit > 1){
          ...
          $snext = ($ipage == 1) ? "<li class='{$aclass_options['disabled_class']}'><a>&laquo; prev</a></li>" : "<li><a href='?{$spage_acr}=". ($ipage-1) . "{$sqry_string}' >&laquo; prev </a></li>";
          $sprev = ($ipage == $itotal_page) ? "<li class='{$aclass_options['disabled_class']}'><a>next &raquo;</a></li>" : "<li><a href='?{$spage_acr}=". ($ipage+1) . "{$sqry_string}' > next &raquo;</a></li>";
          ...
          for ($ilink = 1; $ilink <= $itotal_page; $ilink++){
             if ($ilink == 2 && $ipage >= ($iinterval + 3)){
                $shtml .= "<li class='{$aclass_options['li_class']}'><a href='?{$spage_acr}=1{$sqry_string}' >1</a></li><li><a>&nbsp;&hellip;&nbsp;</a></li>";
             }elseif($ilink == 1 && $ipage == ($iinterval + 2)){
                $shtml .= "<li><a href='?{$spage_acr}=1{$sqry_string}'>1</a>&nbsp;</li>";
             }
             if ($ilink == $ipage){
                $shtml .= "<li  ><a class='{$aclass_options['active_class']}'>$ipage</a>&nbsp;</li>";
             }elseif ($ilink >= ($ipage - $iinterval)){
                $shtml .= "<li class='{$aclass_options['li_class']}'><a href='?{$spage_acr}=$ilink{$sqry_string}' >$ilink</a>&nbsp;</li>";
             }
             if ($ilink >= ($ipage + $iinterval) && ($itotal_page - ($iinterval + 2)) >= $ipage){
                $shtml .= "<li class='{$aclass_options['li_class']}'><a>&hellip;&nbsp;</a></li><li><a href='?{$spage_acr}=$itotal_page{$sqry_string}'>$itotal_page</a></li>";
                break;
             }
          }
          $shtml .= $sprev;
   ...
   public function sql_limit($itotal_rows, $iper_page, $spage_acr = "page", $srow_acr = "row" )
   {
      ...
      $ipage = ($ifilter_page==="" || $ifilter_page===false) ? 1 : $ifilter_page;
